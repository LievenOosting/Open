...
public class SpanUtil {
	 ...
	 * 19、TextAppearanceSpan 文本外貌（包括字体、大小、样式和颜色） 20、TypefaceSpan 文本字体 21、URLSpan
	 * 文本超链接
	 **/
	/**
	...
	/**
	 * 10 AbsoluteSizeSpan 绝对大小（文本字体）因为此处指定的字号大小以px为单位，要用的话可以DisplayUtil 转换即可
	 * 
	 * @param context
	 * @param start_index
	 * @param end_index
	 ...
	 *            设为0则到最后
	 * @param family
	 *            The font family for this typeface. Examples include monospace,
