 ...
 * 比如一个发一个帖子，下面是评论
 */
public abstract class BaseHaveHeaderListActivity<T1 extends Entity, T2 extends Serializable>
        extends BaseListActivity<T1> {
            ...
            try {
                if (arg2 != null) {
                    ...
                    if (detail != null) {
                        ...
                        new SaveCacheTask(BaseHaveHeaderListActivity.this, detail,
    ...
    protected void readDetailCacheData(String cacheKey) {
        new ReadCacheTask(BaseHaveHeaderListActivity.this).execute(cacheKey);
    }
